...
export default function Footer() {
  return (
    <footer>
      <div className="flex flex-col items-center md:items-start lg:flex-row lg:items-center lg:justify-between">
        <Logo />
        <Navigation />
      </div>
      <div className="mt-9 grid gap-y-14 md:grid-cols-2">
        <p className="text-center md:col-span-2 md:text-start lg:col-span-1">
